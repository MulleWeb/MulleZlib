...
if( STANDALONE)
   if( NOT LIBRARY_NAME)
      set( LIBRARY_NAME "MulleObjCZlibFoundation")
   endif()

   if( NOT STANDALONE_NAME)
      set( STANDALONE_NAME "MulleObjCZlibFoundation-standalone")
   endif()

   if( NOT STANDALONE_DEFINITIONS)
      set( STANDALONE_DEFINITIONS ${MULLE_OBJC_ZLIB_FOUNDATION_DEFINITIONS})
   endif()
   ...
   if( NOT STANDALONE_ALL_LOAD_LIBRARIES)
      set( STANDALONE_ALL_LOAD_LIBRARIES
         $<TARGET_FILE:MulleObjCZlibFoundation>
...
int  ___mulle_objc_zlib_foundation_unused__;
